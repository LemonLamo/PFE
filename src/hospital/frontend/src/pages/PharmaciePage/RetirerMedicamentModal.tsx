...
export default function RetirerMedicamentModal({isOpen, close}: Props) {
    ...
    function select_medicament(medicament : any) {
        if(medicament)
    ...
    return (
        <Modal isOpen={isOpen} icon="fa fa-bed" theme={theme} size="sm:max-w-2xl">
            ...
            <div className="flex justify-end gap-3">
                <button type="submit" className={`${ModalThemes[theme].color} rounded-md px-4 py-2 font-semibold text-white`} onClick={() => handleSubmit(selectedMedicament)}>Retirer</button>
