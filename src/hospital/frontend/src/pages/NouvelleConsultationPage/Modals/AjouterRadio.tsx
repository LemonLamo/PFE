...
export default function AjouterRadio({isOpen, close, action}: Props) {
    ...
    return (
        createPortal(
        <Modal isOpen={isOpen} icon="fa fa-x-ray" theme={theme} size="sm:max-w-2xl">
            <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-3">Ajouter un radio</h3>
            <p className="text-gray-600"> Remplissez ce formulaire pour ajouter un radio.</p>
            <form onReset={reset}>
