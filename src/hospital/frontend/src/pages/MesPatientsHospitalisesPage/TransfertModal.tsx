  ...
  const { showAlert } = useContext(AlertsContext);
    ...
    async function submit(){
      try {
        ...
        await ajouterTransfert(selectedHospitalisation.id, transfert);
    ...
    return (
        <Modal isOpen={isOpen} icon="fa fa-truck-medical" theme={theme} size="sm:max-w-2xl">
            ...
            <p className="text-gray-600"> Remplissez ce formulaire pour transférer <span className="font-bold">{selectedHospitalisation.patient.nom} {selectedHospitalisation.patient.prenom}</span>.</p>
