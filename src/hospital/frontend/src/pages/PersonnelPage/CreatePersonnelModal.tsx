...
export default function CreatePersonnelModal({isOpen, close}: Props) {
  ...
  return (
    <Modal isOpen={isOpen} icon="fa fa-user" theme={theme} size="sm:max-w-5xl">
      <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-3"> Créer une Personnel </h3>
      <p className="text-gray-600"> Remplissez ce formulaire pour ajouter une nouvelle Personnel </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input type="date" className="primary" placeholder="Date de naissance" {...register('date_de_naissance')}/>
            </div>
            <div>
      ...
      <div className="flex justify-end gap-3 col-span-2">
          <button type="submit" className={`${ModalThemes[theme].color} rounded-md px-4 py-2 font-semibold text-white`} onClick={handleSubmit(onSubmit)}>Ajouter</button>
