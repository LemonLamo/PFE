...
export default function AjouterAntecedentFamilial({isOpen, close, action}: Props) {
    ...
    return (
        ...
        <Modal isOpen={isOpen} icon="fa fa-clock-rotate-left" theme={theme} size="sm:max-w-2xl">
            <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-3"> Ajouter une antécédent familial </h3>
            <p className="text-gray-600"> Remplissez ce formulaire pour ajouter un antécédent familial.</p>
            <form onReset={reset}>
