...
function NouvelleHospitalisationPage() {
  ...
  function choosePatient() {
    if (hospitalisationData.patient!.NIN !== "") setValidPatient(true);
        ...
        >
          <div className="flex w-inherit">
            <PatientsSelect
              ...
              state={{
                NIN: hospitalisationData.patient!.NIN!,
                nom: hospitalisationData.patient!.nom!,
                prenom: hospitalisationData.patient!.prenom!,
              }}
            />
