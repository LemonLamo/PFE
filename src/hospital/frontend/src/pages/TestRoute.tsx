  ...
  const timelineitems = [
    {
      ...
      patient: {
        ...
        nom: "NADIL",
        prenom: "Marwa",
        date_de_naissance: new Date("2002-05-12"),
        sexe: "Femme",
        groupage: "O+",
      },
      medecin: {
    ...
    },
    {
      ...
      chambre: "F1",
      lit: 1,
      date_sortie: new Date("2023-02-18T00:00:00.000Z"),
      mode_sortie: "Ambulance",
      motif_hospitalisation: "Soupçon de COVID-19",
      resume_hospitalisation:
        "Le patient s'est présenté avec une fièvre extra-ordinaire, un mal de gorge, un nez qui coule.",
    },
    {
      id: "interv-XNDHDBZ",
