import Modal from "../ModayDaisy/Modal";
import ModalEdit from "../ModayDaisy/ModalEdit";

type TableEntryProps = {
  data: string[];
};
const labels = ["Name", "Surname"];
const modalFields = ["nadil", "marwa"];
    ...
    <tr>
      ...
      <td className="py-3 text-right flex justify-center gap-2">
        <div className="w-4 transform text-green-500 hover:text-green-700 hover:scale-110">
          ...
          <Modal labels={labels} modalFields={modalFields}></Modal>
        </div>
        <div className="w-4 transform text-yellow-500 hover:text-yellow-700 hover:scale-110">
          ...
          <ModalEdit labels={labels} modalFields={modalFields}></ModalEdit>
        </div>
