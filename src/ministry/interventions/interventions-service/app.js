...
app.get ("/api/interventions/countToday", auth.requireAuth, InterventionsController.selectCountToday);
app.get ("/api/interventions/countByService", auth.requireAuth, InterventionsController.selectCountByService);
